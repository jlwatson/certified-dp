...
python experiment.py --db-size=1000000 --max-degree=1 --dimension=1 --epsilon=0.095 --sparsity=1 --delta=0.0000000001 > eval-comp-db-1000000-d-1-e-0,095-s-1-d-0,0000000001.log
